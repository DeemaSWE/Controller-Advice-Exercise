...
public class InvestorParticipationService {
    ...
    public List<InvestorParticipation> getEventParticipants(Integer eventId){
        ...
        List<InvestorParticipation> participants = investorParticipationRepository.findInvestorParticipationByEventId(eventId);

        if (participants.isEmpty())
            throw new ApiException("No participants found for event");
