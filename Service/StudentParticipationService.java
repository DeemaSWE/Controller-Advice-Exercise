...
public class StudentParticipationService {
    ...
    public List<StudentParticipation> getEventParticipants(Integer eventId){
        ...
        List<StudentParticipation> studentParticipationList = studentParticipationRepository.findStudentParticipationByEventId(eventId);

        if(studentParticipationList.isEmpty())
            throw new ApiException("No student participated in event with id " + eventId);
